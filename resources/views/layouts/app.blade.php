                ...
                <div class="flex">
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        @if(Auth::user()->hasRole('Cliente'))
                            <a href="{{ route('mis-turnos') }}" class="text-xl font-bold text-indigo-600">Belleza Spa</a>
                        @else
                            <a href="{{ route('dashboard') }}" class="text-xl font-bold text-indigo-600">Belleza Spa</a>
                        @endif
                    </div>
